...
class NationalIdForSearch implements ValidationRule
{
    /**
     * Run the validation rule.
     * هذا التحقق أكثر مرونة للبحث - لا يتحقق من صحة رقم الهوية الفلسطينية
     * لأن المستخدم قد يبحث عن رقم موجود فعلاً في قاعدة البيانات
     */
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        // لا نتحقق من صحة رقم الهوية الفلسطينية عند البحث
        // لأن المستخدم قد يبحث عن رقم موجود فعلاً في قاعدة البيانات
    }
}
