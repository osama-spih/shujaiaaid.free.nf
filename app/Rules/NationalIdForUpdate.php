...
class NationalIdForUpdate implements ValidationRule
{
    private $currentIdentityId;

    public function __construct($currentIdentityId = null)
    {
     ...
     * هذا التحقق أكثر مرونة عند التحديث - يسمح بالأرقام الموجودة مسبقاً
     */
